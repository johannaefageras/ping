...
signupForm.addEventListener("submit", async (e) => {
  ...
  if (error) {
    if ((error.message || "").toLowerCase().includes("username_taken")) {
      showAuthError("Användarnamnet är redan taget.");
    } else {
...
function fileTypeIcon(name) {
  ...
  const map = {
    jpg: "pi-file-jpg", jpeg: "pi-file-jpg",
    png: "pi-file-png",
    gif: "pi-file-image", webp: "pi-file-image", bmp: "pi-file-image", tiff: "pi-file-image", heic: "pi-file-image",
    svg: "pi-file-svg",
    ai: "pi-file-vector", eps: "pi-file-vector",
    mp4: "pi-file-mp4",
    mov: "pi-file-mov",
    avi: "pi-file-video", mkv: "pi-file-video", webm: "pi-file-video", m4v: "pi-file-video",
    mp3: "pi-file-mp3",
    wav: "pi-file-wav",
    ogg: "pi-file-audio", flac: "pi-file-audio", m4a: "pi-file-audio", aac: "pi-file-audio",
    pdf: "pi-file-pdf",
    zip: "pi-file-zip", rar: "pi-file-archive", "7z": "pi-file-archive", tar: "pi-file-archive", gz: "pi-file-archive",
    doc: "pi-file-doc", docx: "pi-file-doc", odt: "pi-file-doc", rtf: "pi-file-doc",
    xls: "pi-file-spreadsheet", xlsx: "pi-file-spreadsheet", csv: "pi-file-spreadsheet", ods: "pi-file-spreadsheet",
    html: "pi-file-html", htm: "pi-file-html",
    css: "pi-file-css", scss: "pi-file-css", sass: "pi-file-css", less: "pi-file-css",
    json: "pi-file-brackets-curly",
    js: "pi-file-code", mjs: "pi-file-code", ts: "pi-file-code", tsx: "pi-file-code", jsx: "pi-file-code",
    py: "pi-file-code", rb: "pi-file-code", go: "pi-file-code", rs: "pi-file-code",
    java: "pi-file-code", c: "pi-file-code", cpp: "pi-file-code", h: "pi-file-code", sh: "pi-file-code",
    txt: "pi-file-text", md: "pi-file-text", log: "pi-file-text",
  };
